 ...
 * <!-- end-user-doc -->
 * @see ca.mcgill.emf.examples.hal.HalPackage#getBinaryLogicalOperator()
 * @model
 * @generated
 */
public enum BinaryLogicalOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BinaryLogicalOperator[] VALUES_ARRAY = new BinaryLogicalOperator[] { AND, OR, };
