 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.ActionImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectWithInverseResolvingEList.ManyInverse<Command>(Command.class, this,
					HalPackage.ACTION__COMMANDS, HalPackage.COMMAND__ACTIONS);
		}
		return commands;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HalPackage.ACTION__COMMANDS:
