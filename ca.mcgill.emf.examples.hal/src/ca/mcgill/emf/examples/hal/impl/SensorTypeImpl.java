 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.SensorTypeImpl#getSensors <em>Sensors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensorTypeImpl extends DeviceTypeImpl implements SensorType {
	/**
	...
	protected EClass eStaticClass() {
		return HalPackage.Literals.SENSOR_TYPE;
	}
	...
	public EList<Sensor> getSensors() {
		if (sensors == null) {
			sensors = new EObjectWithInverseResolvingEList<Sensor>(Sensor.class, this, HalPackage.SENSOR_TYPE__SENSORS,
					HalPackage.SENSOR__SENSOR_TYPE);
		}
		return sensors;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HalPackage.SENSOR_TYPE__SENSORS:
