 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.DeviceTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeviceTypeImpl extends MinimalEObjectImpl.Container implements DeviceType {
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HalPackage.DEVICE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HalPackage.DEVICE_TYPE__TYPE:
			return getType();
		}
