 ...
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.RoomImpl#getDevices <em>Devices</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends MinimalEObjectImpl.Container implements Room {
	...
	public EList<Device> getDevices() {
		if (devices == null) {
			devices = new EObjectWithInverseResolvingEList<Device>(Device.class, this, HalPackage.ROOM__DEVICES,
					HalPackage.DEVICE__ROOM);
		}
		return devices;
	}
